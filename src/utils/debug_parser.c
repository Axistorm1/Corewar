...
//         printf("INDEX %d || ", i);
//         printf("OP_CODE %d || ", parse_data->instruction[i]->op_code);
//         if (parse_data->instruction[i]->coding_byte != 0) {
//             printf("coding_byte %d\n", parse_data->instruction[i]->coding_byte);
//         } else {
//             printf("no coding_byte\n");
//         }
//         for (int j = 0; j != 3; j++) {
